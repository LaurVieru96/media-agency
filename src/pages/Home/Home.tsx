...
// 				<div>
// 					<img
// 						className="w-full mx-auto grayscale-75"
// 						src={background}
// 						alt="background"
// 					/>
// 				</div>
...
// 			{/* Who We Are Section */}
// 			<div className="bg-gray-50 dark:bg-gray-800 py-16 mt-24">
// 				<div className="container mx-auto px-5 md:px-0">
// 					<div className="text-center mb-12">
// 						<h2 className="text-3xl font-bold mb-6">Cine Suntem Noi?</h2>
...
// 							pasiunea pentru dezvoltarea web într-un vis împlinit, oferind soluții digitale 
// 							care transformă ideile clienților noștri în realitate.
// 						</p>
// 						<button type="button" className="mt-8 bg-black dark:bg-white text-white dark:text-black rounded-full font-medium py-3 px-8 hover:opacity-90 transition-opacity">
// 							Contactează-ne
// 						</button>
// 					</div>
// 				</div>
...
// 					<p className="text-lg mb-12">Soluții complete pentru prezența ta online</p>
// 				</div>

// 				<div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-8 md:p-12 max-w-4xl mx-auto">
// 					<div className="text-center">
// 						<h3 className="text-2xl font-bold mb-4">Web Development</h3>
// 						<p className="mb-6">
// 							Oferim servicii complete de dezvoltare web, acoperind atât partea de frontend cât și backend.
// 							Echipa noastră creează interfețe moderne și intuitive, perfect funcționale pe toate 
// 							dispozitivele, susținute de sisteme backend robuste și eficiente. De la site-uri de prezentare 
// 							la platforme web complexe, transformăm viziunea ta într-o experiență digitală deosebită.
// 						</p>
// 						<div className="flex flex-wrap justify-center gap-8 mt-8">
// 							<div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md w-full md:w-64">
// 								<div className="text-xl font-semibold mb-2">Frontend</div>
// 								<p>Interfețe intuitive și responsive, optimizate pentru experiența utilizatorului</p>
// 							</div>
// 							<div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md w-full md:w-64">
// 								<div className="text-xl font-semibold mb-2">Backend</div>
// 								<p>Sisteme robuste și securizate pentru funcționalitate și performanță optimă</p>
// 							</div>
// 						</div>
// 					</div>
// 				</div>
...
// 				<div className="container mx-auto px-5 md:px-0">
// 					<h2 className="text-4xl md:text-5xl font-bold mb-3">Dev Union Agency</h2>
// 					<p className="text-xl">Since 2025</p>
// 				</div>
// 			</div>
...
// 			<div className="container mx-auto px-5 md:px-0 py-16">
// 				<div className="text-center mb-12">
// 					<h2 className="text-3xl font-bold mb-3">Prețuri și Pachete</h2>
// 					<p className="text-lg mb-6">Soluții adaptate pentru fiecare nevoie</p>
// 				</div>
...
// 							</li>
// 						</ul>
// 						<button type="button" className="mt-auto bg-black dark:bg-white text-white dark:text-black rounded-full font-medium py-2 px-4 hover:opacity-90 transition-opacity">
// 							Solicită ofertă
// 						</button>
// 					</div>
...
// 					<div className="border rounded-xl p-6 flex flex-col h-full">
// 						<h3 className="text-xl font-bold mb-3">Platformă Web</h3>
// 						<p className="text-3xl font-bold mb-6">3000€</p>
// 						<ul className="mb-8 flex-grow">
// 							<li className="mb-2 flex items-start">
// 								<svg className="w-5 h-5 mr-2 text-green-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
// 									<title>{""}</title><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"/>
